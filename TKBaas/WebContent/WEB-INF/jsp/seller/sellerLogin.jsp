...
<body>
	...
	<div id="login-main-content" style="background-color:#2a3b4c;">
		<div class="comWidth">
			<div class="login-content">
				<div class="main-content-bg" style="background:url(/TKBaas/images/login/login_bg2.png) no-repeat"></div>
				<div class="main-content-right">
					...
					<a class="link-register" href="/TKBaas/seller/pc/registForm">立即注册</a>
				</div>
			</div>
		</div>
	</div>
