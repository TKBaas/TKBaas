	...
	<section class="manage-content">
		<div class="leftBar">
			<div>
				<ul>
					<li>
						<p class="ul-control"><i class="fa fa-home"></i>店铺信息<i class="fa fa-caret-down caret"></i></p>
						<ul class="change_height">
							<li><a href="/TKBaas/seller/pc/home"><i class="fa fa-server"></i>店铺信息</a></li>
					...
					<li>
						...
						<ul class="change_height">
							<li class="li_active"><a href="/TKBaas/product/pc/addProductForm"><i class="fa fa-columns"></i>发布商品</a></li>
			...
			<div class="right-content">
				<form:form commandName="product" id="uploadForm" action="${pageContext.request.contextPath}/product/pc/addProduct" method="post" enctype="multipart/form-data">
                	...
                	<form:select name="type" path="type">
                		...
                		<option value="车厘子/樱桃">车厘子/樱桃</option>
                		<option value="芒果">芒果</option>
                		<option value="柠檬">柠檬</option>
                		<option value="柚">柚</option>
                		...
                		<option value="奇异果/猕猴桃">奇异果/猕猴桃</option>
                	</form:select>
                	
                	水果场地：
                	<form:select name="city" path="city">
                		<option value="west">南果缤纷</option>
                		<option value="north">北果风光</option>
                		<option value="south">西域国情</option>
                	</form:select>
