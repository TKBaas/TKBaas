...
<body onload="getOnLoadPage(1)">
    ...
    <div id="search-nav">
        <div class="comWidth clearfix">
            <div class="nav-brand fl"><a href="/TKBaas/product/pc/home"></a></div>
            <form method="post" action="/TKBaas/product/pc/searchProduct">
                        ...
                        <div class="container-box">
                            ...
                            <div class="container-item-box fl">
                                <div class="menu-item-brand menu-item">
                                    ...
                                    <div class="menu-content">
                                        <ul class="menu-sub-list">
                                            <li class="menu-sub-item-op"><a href="/TKBaas/product/pc/getListByAll?key=苹果">苹果</a></li>
											<li class="menu-sub-item-op"><a href="/TKBaas/product/pc/getListByAll?key=橙子">橙子</a></li>
											<li class="menu-sub-item-op"><a href="/TKBaas/product/pc/getListByAll?key=车厘子/樱桃">车厘子/樱桃</a></li>
											<li class="menu-sub-item-op"><a href="/TKBaas/product/pc/getListByAll?key=芒果">芒果</a></li>
											<li class="menu-sub-item-op"><a href="/TKBaas/product/pc/getListByAll?key=柠檬">柠檬</a></li>
											<li class="menu-sub-item-op"><a href="/TKBaas/product/pc/getListByAll?key=柚">柚</a></li>
											<li class="menu-sub-item-op"><a href="/TKBaas/product/pc/getListByAll?key=石榴">石榴</a></li>
											<li class="menu-sub-item-op"><a href="/TKBaas/product/pc/getListByAll?key=山竹">山竹</a></li>
											<li class="menu-sub-item-op"><a href="/TKBaas/product/pc/getListByAll?key=哈密瓜">哈密瓜</a></li>
											<li class="menu-sub-item-op"><a href="/TKBaas/product/pc/getListByAll?key=蓝莓">蓝莓</a></li>
											<li class="menu-sub-item-op"><a href="/TKBaas/product/pc/getListByAll?key=西瓜">西瓜</a></li>
											<li class="menu-sub-item-op"><a href="/TKBaas/product/pc/getListByAll?key=梨">梨</a></li>
											<li class="menu-sub-item-op"><a href="/TKBaas/product/pc/getListByAll?key=水蜜桃">水蜜桃</a></li>
											<li class="menu-sub-item-op"><a href="/TKBaas/product/pc/getListByAll?key=牛油果">牛油果</a></li>
											<li class="menu-sub-item-op"><a href="/TKBaas/product/pc/getListByAll?key=火龙果">火龙果</a></li>
											<li class="menu-sub-item-op"><a href="/TKBaas/product/pc/getListByAll?key=百香果">百香果</a></li>
											<li class="menu-sub-item-op"><a href="/TKBaas/product/pc/getListByAll?key=热带水果">热带水果</a></li>
											<li class="menu-sub-item-op"><a href="/TKBaas/product/pc/getListByAll?key=奇异果/猕猴桃">奇异果/猕猴桃</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="menu-item-fresh menu-item">
                                    ...
                                    <div class="menu-content">
                                        <ul class="menu-sub-list">
                                            <li class="menu-sub-item-op"><a href="/TKBaas/product/pc/getListByAll?key=南果缤纷">南果缤纷</a></li>
											<li class="menu-sub-item-op"><a href="/TKBaas/product/pc/getListByAll?key=西域果情">西域果情</a></li>
											<li class="menu-sub-item-op"><a href="/TKBaas/product/pc/getListByAll?key=北果风情">北果风情</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div><!-- 导航栏其他导航 -->
                        ...
                        <li class="select-list">
                            <dl id="select1" class="clearfix">
                                ...
                                <div class="dd-content" >
                                    ...
                                    <dd><a href="/TKBaas/product/pc/getListByAll?key=苹果">苹果</a></dd>
                                    <dd><a href="/TKBaas/product/pc/getListByAll?key=橙子">橙子</a></dd>
                                    <dd><a href="/TKBaas/product/pc/getListByAll?key=车厘子/樱桃">车厘子/樱桃</a></dd>
                                    <dd><a href="/TKBaas/product/pc/getListByAll?key=芒果">芒果</a></dd>
                                    <dd><a href="/TKBaas/product/pc/getListByAll?key=柠檬">柠檬</a></dd>
                                    <dd><a href="/TKBaas/product/pc/getListByAll?key=柚">柚</a></dd>
                                    <dd><a href="/TKBaas/product/pc/getListByAll?key=石榴">石榴</a></dd>
                                    <dd><a href="/TKBaas/product/pc/getListByAll?key=山竹">山竹</a></dd>
                                    <dd><a href="/TKBaas/product/pc/getListByAll?key=哈密瓜">哈密瓜</a></dd>
                                    <dd><a href="/TKBaas/product/pc/getListByAll?key=蓝莓">蓝莓</a></dd>
                                    <dd><a href="/TKBaas/product/pc/getListByAll?key=西瓜">西瓜</a></dd>
                                    <dd><a href="/TKBaas/product/pc/getListByAll?key=梨">梨</a></dd>
                                    <dd><a href="/TKBaas/product/pc/getListByAll?key=水蜜桃">水蜜桃</a></dd>
                                    <dd><a href="/TKBaas/product/pc/getListByAll?key=牛油果">牛油果</a></dd>
                                    <dd><a href="/TKBaas/product/pc/getListByAll?key=火龙果">火龙果</a></dd>
                                    <dd><a href="/TKBaas/product/pc/getListByAll?key=百香果">百香果</a></dd>
                                    <dd><a href="/TKBaas/product/pc/getListByAll?key=热带水果">热带水果</a></dd>
                                    <dd><a href="/TKBaas/product/pc/getListByAll?key=荔枝">荔枝</a></dd>
                                    <dd><a href="/TKBaas/product/pc/getListByAll?key=奇异果/猕猴桃">奇异果/猕猴桃</a></dd>
                                </div>
                            </dl>
                        </li>
                        <li class="select-list">
                            <dl id="select2"  class="clearfix">
                                ...
                                <div class="dd-content">
                                    <dd class="select-all selected"><a href="#">不限</a></dd>
                                    <dd><a href="/TKBaas/product/pc/getListByAll?key=南果缤纷">南果缤纷</a></dd>
                                    <dd><a href="/TKBaas/product/pc/getListByAll?key=西域果情">西域果情</a></dd>
                                    <dd><a href="/TKBaas/product/pc/getListByAll?key=北果风情">北果风情</a></dd>
                                    <!--  
                                    <dd><a href="#">新疆</a></dd>
                                    <dd><a href="#">新疆</a></dd>
                                    <dd><a href="#">新疆</a></dd>
       ...
       function jsonResponse(request){
    	      ...
    	      for(var i = 0; i < result.length; i ++){
    	    	  ...
    	    	  var temp = '<div class="item-list-model"><div class="item-list-content">'
                           + '<a href="/TKBaas/product/pc/getInfo?productId='+ result[i].id +'" target="_blank"><img src="/TKBaas/imgs/' + temp1 + '"></a>'
                           + '<div><h4>'     + result[i].name + "  " + result[i].description + '</h4>'
                           + '<p><i>¥</i>'   + result[i].price + '</p>'
                           + '<p>销量:<span>' + result[i].sales  + '</span></p>'
                           + '</div></div><a href="${pageContext.request.contextPath }/cart/pc/addInCart?num=1&productId=' +result[i].id + '" target="_blank"><i class="fa fa-shopping-cart"></i>'
