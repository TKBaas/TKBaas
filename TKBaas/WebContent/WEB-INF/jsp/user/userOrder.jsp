                                ...
                                <div class="extra-r">
                                    <div class="search">
                                        <form method="post" action="/TKBaas/order/pc/searchUserOrder">
                                         <input type="text" name="key" placeholder="订单信息" id="key" value="${key}">
        ...
        var el = '<table class="td-void order-tb"><colgroup><col class="number-col"><col class="consignee-col">'
	      ...
	      for(var i = 0; i < result.length; i ++){
	    	 ...
	    	 var picTemp = result[i].picture;
	    	  ...
	    	  var temp = '<tbody id="'+ result[i].id +'"><input type="hidden" name="order-status-input" class="order-status-input" value="'+ result[i].state +'">'
	      ...
	      var pageNum = '<div  class="page-ctrl-bar" style="width:100%;">';
