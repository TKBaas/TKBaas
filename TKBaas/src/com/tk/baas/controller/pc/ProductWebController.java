...
public class ProductWebController {
	...
	public String show(Model model,HttpServletRequest request) throws IOException{
		String key = null;
	...
	public String searchProduct(Model model,HttpServletRequest request) throws IOException{
		String key = null;
		if(null != request.getParameter("key")) {
